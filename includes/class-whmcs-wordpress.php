...
class Whmcs_Wordpress {
     ...
     * @since    1.0.0
     * @access   protected
     * @var      Whmcs_Wordpress_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
    ...
    private function define_public_hooks() {
        $plugin_public = new Whmcs_Wordpress_Public($this->get_plugin_name(), $this->get_version());

        $this->loader->add_shortcode('whmcslogin', $plugin_public, 'shortcode_whmcs_wordpress');
    }
     ...
     *
     * @since     1.0.0
     * @return    Whmcs_Wordpress_Loader    Orchestrates the hooks of the plugin.
     */
